...
- Roadmap kaynağı [docs/roadmap.md](/Users/enesonmez/Projects/paper-portfolio-ink/docs/roadmap.md) dosyasıdır.
...
- Dosya yolu: `docs/features/{Phase#}_{Task#}_{FeatureName}.md`
- İçerik:
...
- Feature'a başlamadan önce `features/{Phase#}_{Task#}_{FeatureName}` formatına yakın, açıklayıcı bir branch aç.
