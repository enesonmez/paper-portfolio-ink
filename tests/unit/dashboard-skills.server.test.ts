...
import type * as SkillFormServerModule from "../../app/lib/skills/skill-form.server";
...
vi.mock("../../app/lib/skills/skills.server", () => ({
...
vi.mock("../../app/lib/skills/skill-form.server", async () => {
  const actual = await vi.importActual<typeof SkillFormServerModule>(
    "../../app/lib/skills/skill-form.server",
  );
