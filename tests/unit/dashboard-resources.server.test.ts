...
import type * as ResourceFormServerModule from "../../app/lib/resources/resources-form.server";
...
vi.mock("../../app/lib/resources/resources.server", () => ({
...
vi.mock("../../app/lib/resources/resources-form.server", async () => {
  const actual = await vi.importActual<typeof ResourceFormServerModule>(
    "../../app/lib/resources/resources-form.server",
  );
