...
export function buildDashboardPostsCopy(t: I18nTranslator) {
  ...
  return {
    ...
    clearFiltersLabel: t("dashboard.posts.clearFiltersLabel"),
    ...
    paginationNextLabel: t("dashboard.posts.paginationNextLabel"),
    paginationPreviousLabel: t("dashboard.posts.paginationPreviousLabel"),
    ...
    searchActionLabel: t("dashboard.posts.searchActionLabel"),
    searchLabel: t("dashboard.posts.searchLabel"),
    searchPlaceholder: t("dashboard.posts.searchPlaceholder"),
    statusFilterLabel: t("dashboard.posts.filter.status.label"),
