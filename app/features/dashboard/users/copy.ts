...
export function buildDashboardUsersCopy(t: I18nTranslator) {
  ...
  return {
    ...
    paginationNextLabel: t("dashboard.users.paginationNextLabel"),
    paginationPreviousLabel: t("dashboard.users.paginationPreviousLabel"),
    ...
    roleFilterLabel: t("dashboard.users.filter.role.label"),
    searchActionLabel: t("dashboard.users.searchActionLabel"),
    searchLabel: t("dashboard.users.searchLabel"),
